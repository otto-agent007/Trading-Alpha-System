# ARCHIVED: Stock-based vectorbt backtesting engine.
# Superseded by agents/backtest_engineer.py (prediction market evaluator).
# Kept for reference — do not import in main pipeline.
